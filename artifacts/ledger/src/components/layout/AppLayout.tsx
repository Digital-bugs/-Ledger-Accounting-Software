      ...
      <div className="flex h-screen w-full flex-col overflow-hidden bg-background">
        ...
        <header className="flex h-14 shrink-0 items-center justify-between border-b border-border bg-card px-6 gap-4">
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            />
            <span className="font-semibold text-foreground hidden lg:block">Ledger Accounting Software</span>
          </div>
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            <PeriodFilter />
            <div className="text-sm font-medium text-muted-foreground hidden xl:block whitespace-nowrap">
